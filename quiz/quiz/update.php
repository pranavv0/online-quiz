...
if (isset($_SESSION['key'])) {
    if (@$_GET['sname'] && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        $sname = @$_GET['sname'];
         mysqli_query($con, "INSERT INTO suser VALUES ('$sname')");
         mysqli_query($con, "DELETE FROM online WHERE username='$sname' ");
...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'rmuser' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        $name = @$_GET['name'];
        $result = mysqli_query($con, "SELECT * FROM online WHERE username='$name' ") or die('Error');
        while ($row = mysqli_fetch_array($result)) {
            $r1 = mysqli_query($con, "DELETE FROM online WHERE username='$name'") or die('Error');
        }
